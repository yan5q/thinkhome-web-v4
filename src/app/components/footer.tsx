        ...
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    {links.map((link) => (
                        <a key={link.title} href={link.href} className="text-muted-foreground hover:text-primary block duration-150">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    ...
                    <a href="#" target="_blank" rel="noopener noreferrer" aria-label="aedIn" className="text-muted-foreground hover:text-primary block">
                        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                ...
                <span className="text-muted-foreground block text-center text-sm">© {new Date().getFullYear()} ThinkHome, All rights reserved</span>
            </div>
        </footer>
    );
}
