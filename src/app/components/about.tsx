...
export default function About() {
    return (
        <div>
            <div className="flex flex-col items-center justify-center justify-self-center p-10 pb-0 w-[40vw]">
                <h1 className="text-3xl font-bold">Co vlastně děláme?</h1>
                <h2 className="text-lg text-muted-foreground">Různé IT řešení, jako:</h2>
            </div>
            <div className="cursor-pointer">
                <Link href="/sluzby">
                    <ScrollVelocity velocity={20} texts={["| Weby na zakázku | Kyberbezpečnost | AI | Cloud", "| IT správa | Repasování | Sítě"]} />
               <h2 className="text-lg text-muted-foreground text-center">A další... klikněte pro více.</h2>
                </Link>
            </div>
